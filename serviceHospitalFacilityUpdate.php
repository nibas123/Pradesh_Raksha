...
$sql_facilitiesinuse="select * from m_hospital_used where loginid=? and isactive='1'";
$data=array($loginid);
$format=array("d");
...
$sql_facilityupdate="update m_hospital set nobeds=?,noicubeds=?,novents=?,noambs=?,norooms=?,nowards=?,noppes=?,manadequate=?,modifiedDate=now()".
" where loginid=? and isactive='1'";
$data=array($nobeds,$noicubeds,$novents,$noambs,$norooms,$nowards,$noppes,$manadequate,$loginid);
