...
<body style="margin:0px; padding:0px;">
        ...
        <div style="margin-left:30px;">
            <form class="form-inline" action="">
				<div class="form-group" style="margin-right: 10px;">
                    <label for="usr" class="text-color">District</label>
					<select class="form-control" id="cboDistrict" name="cboDistrict" style="margin-left: 5px;">
						<option value="">--Select District--</option>
							<?php 
								...
								$sql_district="select districtid,districtname from m_district where isactive='1'";
								$list=$db->select($sql_district);
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyABbNypzVAuQJBnTkGiUg_Qfke10sEM_Ac"></script> 
