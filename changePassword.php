...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Pradesh Raksha - Change Password</title>
            ...
            <div class="row">
               <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card card-outline-secondary">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" action="serviceChangePassword.php" autocomplete="off" id="frmPassword" name="frmPassword" novalidate="" method="POST">
                                <div class="form-group">
                                    <label for="inputPasswordOld">Current Password</label>
                                    <input type="password" class="form-control" id="inputPasswordOld" name="inputPasswordOld">
                                </div>
                                <div class="form-group">
...
<!-- <script src="js/jquery-3.2.1.min.js"></script>
  ...
  $("form[name='frmPassword']").validate({
    ...
    rules: {
      ...
      // on the right side
      inputPasswordOld: {required: true,
        minlength:8},
      inputPasswordNew: {
          required: true,
        minlength:8
    ...
    messages: {
        inputPasswordOld: {required:"Please enter your current password",
