                        ...
                        <div class="card-body">
                            <form class="form" role="form" action="serviceNewCovi.php" autocomplete="off" id="frmAdd" name="frmAdd" novalidate="" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                    <input type="text"  maxlength="5"class="form-control" id="nM1" name="nM1" onkeyup="sum()">
                                ...
                                <div class="form-group row">
                                     ...
                                     <div class="col-lg-5">
                                     <input type="text" maxlength="5"class="form-control" id="nF1" name="nF1" onkeyup="sum()">
                                     </div>
                                </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <label  class="col-lg-4 col-form-label form-control-label" for="tIn1">Total No of Inmates</label>
                                   <div class="col-lg-5">
                                  <input type="text" maxlength="5" onchan class="form-control" id="tIn1" name="tIn1" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                    <input type="text"  maxlength="5"class="form-control" id="nM2" name="nM2" onkeyup="sum2()">
                                ...
                                <div class="form-group row">
                                     ...
                                     <div class="col-lg-5">
                                     <input type="text" maxlength="5"class="form-control" id="nF2" name="nF2" onkeyup="sum2()">
                                     </div>
                                </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <label  class="col-lg-4 col-form-label form-control-label" for="tIn2">Total No of Inmates</label>
                                   <div class="col-lg-5">
                                  <input type="text" maxlength="5" class="form-control" id="tIn2" name="tIn2" readonly>
...
<div class="form-group row">
     ...
     <label class="col-lg-4 col-form-label form-control-label" for="tnra"><h5>Total No of Rooms Available</h5></label>
     <div class="col-lg-5">
...
<script src="js/jquery-3.2.1.min.js"></script>
  ...
  <script type="text/javascript">
        function sum() {
            var txtFirstNo = document.getElementById('nM1').value;
            var txtSecondNo = document.getElementById('nF1').value;
            var result = parseInt(txtFirstNo) + parseInt(txtSecondNo);
            if (!isNaN(result)) {
                document.getElementById('tIn1').value = result;
            }
        }
   
        function sum2() {
            var txtFirstNo1 = document.getElementById('nM2').value;
            var txtSecondNo1 = document.getElementById('nF2').value;
            var result1 = parseInt(txtFirstNo1) + parseInt(txtSecondNo1);
            if (!isNaN(result1)) {
                document.getElementById('tIn2').value = result1;
            }
        }
