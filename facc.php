...
$query="select estname,date,city,nM1, nF1, tIn1, nM2, nF2, tIn2, nms, nfs, nmf, nff, nmis, nfis, nrm, nrf, nrlm, nrlf, nim, nif, npsm, npsf, symp, td, nopc, trna, tno FROM m_ciused,m_address WHERE m_ciused.loginid=m_address.loginid AND m_ciused.loginid=?";
$data=array($log);
$format=array();	
...
<tr>
        ...
        <th>Symptomatic</th>
  <th>Test Done</th>
  <th>Total No of Postive cases</th>
  <th>Total Number Of Rooms Available</th>
